...
public class ExerciseBase {
	...
	public final static String pathToRideData = "/Users/1/Desktop/Новая папка(2)/data/nycTaxiRides.gz";
	public final static String pathToFareData = "/Users/1/Desktop/Новая папка(2)/data/nycTaxiFares.gz";
